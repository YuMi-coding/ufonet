...
class UFONetOptions(optparse.OptionParser):
    def __init__(self, *args):
        ...
        group6.add_option("--source", action="store", dest="source", default=None, help="[DDoS] attack a target with spoofed IP address.")
        group6.add_option("--port-start", action='store', dest="port_start", default=None, help='The start of random port range')
        group6.add_option("--port-end", action='store', dest='port_end', default=None, help="The end of random port range")
        # group6.add_option("--speed", action="store", dest="speed", help="[DDoS] attack a target with speed (req/s)")
